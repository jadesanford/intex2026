const t = {
  en: {
    ...
    sections: [
      ...
      { title: 'Cookies', content: 'We use essential cookies and browser storage to keep core features working, such as authentication and consent preferences. Optional analytics-style storage is disabled unless you explicitly accept it through our cookie consent banner.' },
  ...
  tl: {
    ...
    sections: [
      ...
      { title: 'Mga Cookie', content: 'Gumagamit kami ng mahahalagang cookie at browser storage upang gumana ang mga pangunahing feature tulad ng authentication at consent preferences. Naka-disable ang optional analytics-style storage maliban kung tahasan ninyo itong tatanggapin sa cookie banner.' },
