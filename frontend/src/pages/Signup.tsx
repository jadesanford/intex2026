...
const t = {
  en: {
    ...
    passwordMin: 'Password must be at least 14 characters',
    ...
    password: 'Password *',
    passwordPlaceholder: 'Minimum 14 characters',
  ...
  tl: {
    ...
    passwordMin: 'Ang password ay dapat hindi bababa sa 14 na character',
    ...
    password: 'Password *',
    passwordPlaceholder: 'Minimum 14 na character',
...
export default function Signup({ lang }: { lang: 'en' | 'tl' }) {
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      ...
      if (form.password.length < 14) { setError(tx.passwordMin); return false }
